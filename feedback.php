...
<body>
    <div class="container">
        ...
        <script>
            ...
            for (i = 1; i <= 5; i++) {
                ele.innerHTML += `<label for=\"rate${i}\"> <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"16\" height=\"16\" fill=\"currentColor\" class=\"bi bi-star\" viewBox=\"0 0 576 512\">${getStar(true)}</svg></label><input type=\"radio\" id=\"rate${i}\" name=\"rate\" value=\"${i}\"  onclick=\"onRateSet(this)\" hidden>`;
            }
            ...
            // click star
            function onRateSet(e) {
                console.log(e.value);
                ele.innerHTML = "";
                for (i = 1; i <= 5; i++) {
                    ele.innerHTML += `<label for=\"rate${i}\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"16\" height=\"16\" fill=\"currentColor\" class=\"bi bi-star\" viewBox=\"0 0 576 512\">${getStar(e.value < i)}</svg></label><input type=\"radio\" id=\"rate${i}\" name=\"rate\" value=\"${i}\"  onclick=\"onRateSet(this)\" hidden>`;
                }
            }
