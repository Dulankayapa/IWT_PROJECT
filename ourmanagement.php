...
<body>
    <div style="width:100vw ;display: flex;flex-direction: column; margin-top: 10px;">
        <h1 style="font-size: 55px; color: #601749;">
            Our Management Team
        </h1>
        <p style="font-size:30px;">
            This is Our Management Team. We will help with any issue. <br> and help to have a better experience with
            our service.<br>
